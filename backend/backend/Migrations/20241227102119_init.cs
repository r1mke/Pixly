<<<<<<<< HEAD:backend/backend/Migrations/20241229181014_Init1.cs
﻿using System;
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivateCode = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhotoColors", x => new { x.PhotoId, x.ColorId });
                    table.ForeignKey(
                        name: "FK_PhotoColors_Colors_ColorId",
                        column: x => x.ColorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailVerificationCodes_UserId_ActivateCode",
                table: "EmailVerificationCodes",
                columns: new[] { "UserId", "ActivateCode" },
                unique: true);
...
>>>>>>>> 4df56cb8509f440f911d306d09b22512e1d1b87e:backend/backend/Migrations/20241227102119_init.cs
